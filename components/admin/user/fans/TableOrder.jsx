...
import { FaTrash, FaPen, FaLock, FaUnlock } from 'react-icons/fa';
const TableOrder = () => {
  return (
      ...
      <div class="flex flex-col  py-4 sm:flex-row sm:items-start">
        <section class="container relative mx-auto px-4">
          <div class="mr-auto shrink-0 sm:py-3">
            <p class="font-medium">Data Transaction</p>
          </div>
                  ...
                  <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
                      ...
                      <tr>
                        ...
                        <td class="whitespace-nowrap px-4 py-4 text-sm font-medium text-gray-700">
                          <div class="inline-flex items-center gap-x-2 rounded-full bg-red-100/60 px-3 py-1 text-red-500 dark:bg-gray-800">
                            ...
                            <h2 class="text-sm font-normal">Canceled</h2>
                          </div>
                        </td>
                        <td class="whitespace-nowrap px-4 py-4 text-sm text-gray-500 dark:text-gray-300">
                          08237162812
                      ...
                      <tr>
                        ...
                        <td class="whitespace-nowrap px-4 py-4 text-sm font-medium text-gray-700">
                          <div class="inline-flex items-center gap-x-2 rounded-full bg-gray-100/60 px-3 py-1 text-gray-500 dark:bg-gray-800">
                            <svg
                              width="12"
                              height="12"
                              viewBox="0 0 12 12"
                            ...
                            >
                              <path
                                d="M2 2 L8 2 L2 5 L8 5 L2 8 L8 8"
                                stroke="currentColor"
                                stroke-width="1.5"
                                stroke-linecap="round"
                                stroke-linejoin="round"
