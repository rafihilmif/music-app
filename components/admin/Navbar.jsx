...
// import Pict from '../../public/images/commonthumbnails/Gogh.png';
const Navbar = () => {
  return (
    <>
      <header class="antialiased">
        <nav class="relative  mt-5 px-4 py-2.5 lg:px-6">
          <div class="flex flex-wrap items-center justify-between">
            <div class="flex items-center justify-start">
              <a href="#" class="mr-4 flex">
                <span class="self-center whitespace-nowrap text-2xl font-semibold text-white">
                  Create a New Account Fans
                </span>
              </a>
            </div>
            <div class="flex items-center lg:order-2">
              ...
              >
                ...
                <Image src="" className="h-8 w-8 rounded-full" />
              </button>
