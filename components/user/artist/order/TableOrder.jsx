...
export default function TableOrder() {
  return (
    <>
      <div class="relative mx-10 my-1 w-full border  bg-white px-4 shadow-xl sm:rounded-xl">
        <div class="flex flex-col  py-4 sm:flex-row sm:items-start">
          <section class="container relative mx-auto px-1 ">
            <h1 class="mt-2 text-2xl font-bold text-black">
              Data All Your Order
            </h1>
                        ...
                        <tr>
                          ...
                          <td class="whitespace-nowrap px-4 py-4 text-sm">
                            <div class="flex items-center gap-x-1">
                              ...
                              <button
                                type="button"
                                class="mb-2 me-2 rounded-full bg-red-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                              >
                                Decline
                              </button>
                            </div>
